/**
 * STM32MP135C DDR3 1Gb configuration
 * 1x DDR3L 1Gb, 16-bit, 533MHz.
 * Reference used MT41K64M16TW-107 AIT:J from Micron
 *
 * DDR type / Platform	DDR3/3L
 * freq		533MHz
 * width	16
 * datasheet	1
 * DDR density	1Gb (128MB)
 ...
 * Modified for 1Gb by Dan Green 2026
 * All rights reserved.
 *
 ...
 ******************************************************************************
 */
#ifndef STM32MP13XX_DDR3_512MBIT_H
#define STM32MP13XX_DDR3_512MBIT_H

#define DDR_MEM_NAME "DDR3-1066 bin F 1x1Gb 533MHz v1.53"
#define DDR_MEM_SPEED 533000U
#define DDR_MEM_SIZE 0x08000000U   /* 128MByte */
...
#define DDR_ADDRMAP6 0x0F0F0F07U /* Address bits 15, 14, 13 unused (0xF); row 12 used (0x07) */
...
#define DDR_DCR 0x0000000BU /* bit 3: has 8 banks. bits 2-0:  DDR3*/
...
#endif /*STM32MP13XX_DDR3_512MBIT_H*/
